...
class TfIdf:
    ...
    def get_idf(self, term):
        ...
        print 'Actual IDF --- Num Docs total: ' + str(self.get_num_docs()) + '\tNum Docs Term: ' + str(self.term_num_docs[term]) + '\tIDF: ' + str(math.log(float(1 + self.get_num_docs()) / (1 + self.term_num_docs[term]))) + '\n'
